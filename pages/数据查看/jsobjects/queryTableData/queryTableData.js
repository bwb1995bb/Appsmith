export default {
	getData () {
		...
		if( dsId != '' && dbNa != '' && taNa != ''){
			...
			const url = 'http://172.16.92.180:11003/api/v1/datasource/queryTableData?datasourceId='+dsId+'&database='+dbNa+'&table='+taNa
			+'&pageNo='+TableSelect.pageNo+'&pageSize='+TableSelect.pageSize
			+'&orderColumn='+TableSelect.sortOrder.column
			+'&orderAsc='+(TableSelect.sortOrder.order==null?'':TableSelect.sortOrder.order)
			+'&sqlWhere='+sqlWhere
			; 
